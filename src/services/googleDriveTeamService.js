...
if (process.env.GOOGLE_SERVICE_ACCOUNT_JSON) {
  try { credentials = JSON.parse(process.env.GOOGLE_SERVICE_ACCOUNT_JSON); } catch (e) { console.warn('Failed to parse GOOGLE_SERVICE_ACCOUNT_JSON in googleDriveTeamService, using empty credentials'); }
}
